        ...
        <v-flex xs12 sm10 offset-sm1>
            <v-card hover raised>
                <v-toolbar :class="theme.base" dark>
                    <v-toolbar-title>#5 External sorting</v-toolbar-title>
                </v-toolbar>
                <v-card-text class="body-2 secondary--text">
                    <blockquote>
                        Sorting can also be controlled externally by using the <code>pagination</code> prop. Remember that you must
                        apply the <code>.sync</code> modifier. You can also use the prop to set the default sorted column.
                    </blockquote>
                </v-card-text>
                <div class="ma-3">
                    <v-data-table
