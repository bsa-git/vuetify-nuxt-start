        ...
        <v-flex xs12 sm8 offset-sm2>
            <v-card hover raised>
                <v-toolbar :class="theme.base" dark>
                    <v-toolbar-title>#6 With Icon Dark</v-toolbar-title>
                </v-toolbar>
                    ...
                    <v-card class="secondary elevation-0">
                        <v-card-text>
                            <v-container fluid>
                                <v-layout row>
                                    <v-flex xs4>
                                        <v-subheader class="grey--text text--lighten-1">Normal with hint text
                                        </v-subheader>
                                    </v-flex>
                                    <v-flex xs5>
                                        <v-text-field
                                ...
                                <v-layout row>
                                    <v-flex xs4>
                                        <v-subheader class="grey--text text--lighten-1">Normal with input text
                                        </v-subheader>
                                    </v-flex>
                                    <v-flex xs5>
                                        <v-text-field
