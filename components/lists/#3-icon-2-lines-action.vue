        ...
        <v-flex xs12 sm6 offset-sm3>
            <v-card class="" hover raised>
                <v-toolbar :class="theme.base" dark>
                    <v-toolbar-title>#3 Icon with 2 lines and action</v-toolbar-title>
                </v-toolbar>
                <v-card-text class="body-2 secondary--text">
                    <blockquote>
                        Lists can contain subheaders, dividers, and can contain 1 or more lines. The subtitle will
                        overflow with ellipsis if it extends past one line.
                    </blockquote>
                </v-card-text>
